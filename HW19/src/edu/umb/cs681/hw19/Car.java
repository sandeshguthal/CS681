...
public class Car {
    ...
    public static void main(String args[]) {
        ...
        int carCount = carList.stream().parallel()
        ...
        int maxPrice = carList.stream().parallel()
        ...
        System.out.println("Max price using parallel and reduce" + maxPrice);

        int minPrice = carList.stream().parallel()
                .map((Car car) -> car.getPrice())
                .reduce(0,(answer, currCarPrice) -> {
                    if (answer == 0)
                        return currCarPrice;
        ...
        System.out.println("Min price using parallel and reduce" + minPrice);
    }
}
